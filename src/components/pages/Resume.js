...
export default function Skills() {
    return (
        ...
        <h1><a href="https://docs.google.com/document/d/1ZsNZBBRQuoD45Msg1b9llARjsvTBsFCZ/edit?usp=sharing&ouid=115073050941282450900&rtpof=true&sd=true">Resume</a></h1>
        <div className='logos'>
